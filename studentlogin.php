...
<div class="container"> 
    ...
    <!-- Form-->
    <form class="form-horizontal text-center" role="form" action="checklog1.php" method="post">
        ...
        <div class="form-group test2">        
          <div class="col-sm-offset-2 col-sm-8">
            <button type="submit" class="btn btn-success" name="signin2" id="signin2">SignIn</button>        
          </div>
        </div>
